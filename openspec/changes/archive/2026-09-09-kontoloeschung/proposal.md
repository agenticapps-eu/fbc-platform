# Sie können Ihr Konto jetzt selbst löschen
...
- Sie können Ihr Konto **selbst löschen** — in der App, unter *Einstellungen*, hinter
  einer eigenen Rückfrage. Auf iPhone, Android und im Browser derselbe Weg.
- Die Löschung ist **endgültig**: Profil, Kontaktdaten und Ihre Bilder verschwinden,
  und Sie können sich danach nicht mehr anmelden. Auch die Vereinsleitung kann sie
  nicht rückgängig machen.
- Ihre **Beiträge, Kommentare und Nachrichten bleiben ohne Ihren Namen stehen**, damit
  die Gespräche der anderen Mitglieder nicht zerreissen.
- Anmeldungen zu künftigen Veranstaltungen werden storniert, offene Kontaktanfragen
  zurückgezogen.
