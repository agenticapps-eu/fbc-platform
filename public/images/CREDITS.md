...
Alle Bilder liegen **selbst gehostet** in diesem Verzeichnis. Sie werden bewusst
nicht per CDN eingebunden — ein Aufruf an `images.unsplash.com` beim Laden der
Seite wäre derselbe Fremdabruf, den AGE-492 für die Schriften entfernt hat.

Bezogen am 2026-08-04 von Unsplash mit `w=1600&q=45&fm=webp`. Die Kennung ist der
Pfadname des Bildes auf `images.unsplash.com`.

| Datei                      | Verwendet auf               | Motiv                             | Unsplash-Kennung                   |
| -------------------------- | --------------------------- | --------------------------------- | ---------------------------------- |
| `hero-see.webp`            | Dashboard (`/`, eingeloggt) | Stadt am See, Abendlicht (Zürich) | `photo-1598222836613-a3bd8cba5fff` |
| `hero-start.webp`          | Startseite (ausgeloggt)     | Menschen in einem Saal            | `photo-1531058020387-3be344556be6` |
...
die Namen ist die Nutzung lizenzkonform, aber unhöflich — wer sie nachträgt, hat
einen vollständigen Nachweis.
