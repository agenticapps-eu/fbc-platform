...
--    profiles row (tier 'discover'); section 3 enriches it. Idempotent. ────────
...
from (values
  ...
  ('d73efa12-5f11-4220-94b4-dd5880b10782'::uuid,'Carla Reinhardt','prime','Strategieberaterin · Connectorin','{Beraterin,Connectorin}'::text[],'Stuttgart','Reinhardt & Partner','Beratung','DEMO-Profil — fiktive Daten. Strategie- und Organisationsberatung; vernetzt Mandant:innen im Club.','{"Strategie","Organisationsentwicklung","Netzwerk"}'::text[],'{"Leadership","New Work","Netzwerk"}'::text[],'FBC-10210','2021-02-01'::date,'tun',65,90),
  ('2752a480-a737-4f90-af0c-a76722c781a7'::uuid,'Jonas Keller','discover','Gründer · B2B-SaaS','{"Gründer"}'::text[],'Stuttgart','Keller Ventures','Technologie','DEMO-Profil — fiktive Daten. Frühphasen-Gründer auf der Suche nach Kapital und Mentoring.','{"Product Management","SaaS","Vertrieb"}'::text[],'{"Startups","Fintech","KI"}'::text[],'FBC-10455','2024-09-01'::date,'tun',40,60),
  -- new legacy
  ('00000000-0000-0000-0000-000000025401'::uuid,'Dr. Friederike Lang','legacy','Private Equity · Wachstumskapital','{Investorin,Aufsichtsrätin}'::text[],'München','Lang Equity GmbH','Beteiligungen','DEMO-Profil — fiktive Daten. Wachstums- und Nachfolgefinanzierung für den Mittelstand.','{"Private Equity","M&A","Finanzierung","Restrukturierung"}'::text[],'{"Growth Capital","Unternehmensnachfolge","Impact Investing"}'::text[],'FBC-10008','2018-01-15'::date,'wirken',75,100),
  ('00000000-0000-0000-0000-000000025402'::uuid,'Hans-Peter Stadler','legacy','Immobilienentwickler · Bestandshalter','{Unternehmer,Investor}'::text[],'Stuttgart','Stadler Immobilien AG','Immobilien','DEMO-Profil — fiktive Daten. Projektentwicklung und Bestandshaltung von Wohn- und Gewerbeimmobilien.','{"Projektentwicklung","Asset-Management","Finanzierung"}'::text[],'{"Immobilien","Stadtentwicklung","Nachhaltigkeit"}'::text[],'FBC-10015','2016-09-01'::date,'haben',80,100),
  ('00000000-0000-0000-0000-000000025403'::uuid,'Beatrice Sommer','legacy','Executive Coach · Mentorin','{Coach,Mentorin,Speakerin}'::text[],'Hamburg','Sommer Coaching','Beratung','DEMO-Profil — fiktive Daten. Begleitet Unternehmer:innen in Wachstums- und Übergangsphasen.','{"Executive Coaching","Leadership","Change Management"}'::text[],'{"Persönlichkeitsentwicklung","Leadership","Achtsamkeit"}'::text[],'FBC-10022','2019-06-01'::date,'sein',88,100),
  ('00000000-0000-0000-0000-000000025404'::uuid,'Yvonne Albrecht','legacy','Family Office · Impact-Investorin','{Investorin,Stifterin}'::text[],'München','Albrecht Family Office','Family Office','DEMO-Profil — fiktive Daten. Langfristiges Familienkapital mit Impact-Fokus.','{"Wealth Management","Impact Investing","Beteiligungen"}'::text[],'{"Impact Investing","Stiftungen","Nachhaltigkeit"}'::text[],'FBC-10030','2017-11-01'::date,'wirken',90,100),
  ('00000000-0000-0000-0000-000000025405'::uuid,'Philip Brandt','legacy','Corporate Finance · Beteiligungen','{Investor,Banker}'::text[],'Frankfurt','Brandt Capital','Finanzen','DEMO-Profil — fiktive Daten. Strukturierung von Finanzierungen und Beteiligungen für den gehobenen Mittelstand.','{"Corporate Finance","Beteiligungen","M&A"}'::text[],'{"Finanzierung","Mittelstand","Wachstum"}'::text[],'FBC-10037','2018-03-01'::date,'haben',78,100),
  -- new prime
  ('00000000-0000-0000-0000-000000025406'::uuid,'Tobias Wenger','prime','Gründer · Robotik','{"Gründer","CTO"}'::text[],'Stuttgart','Wenger Robotics GmbH','Technologie','DEMO-Profil — fiktive Daten. Skaliert eine Robotik-Plattform für die Industrie und sucht Wachstumskapital.','{"Robotik","KI","Product"}'::text[],'{"Robotik","Industrie 4.0","KI"}'::text[],'FBC-10211','2022-04-01'::date,'tun',70,95),
  ('00000000-0000-0000-0000-000000025407'::uuid,'Gregor Pilz','prime','Projektentwickler Immobilien','{"Unternehmer"}'::text[],'Stuttgart','Pilz Development','Immobilien','DEMO-Profil — fiktive Daten. Quartiers- und Projektentwicklung mit Co-Investoren.','{"Projektentwicklung","Quartiersentwicklung","Finanzierung"}'::text[],'{"Immobilien","Nachhaltiges Bauen"}'::text[],'FBC-10218','2021-07-01'::date,'haben',68,92),
  ('00000000-0000-0000-0000-000000025408'::uuid,'Lena Hofmann','prime','Talent & Netzwerk','{Beraterin,Recruiterin}'::text[],'Stuttgart','Hofmann Talent','Beratung','DEMO-Profil — fiktive Daten. Executive Search und Netzwerkaufbau für wachsende Unternehmen.','{"Executive Search","Employer Branding","Netzwerk"}'::text[],'{"New Work","Talent","Netzwerk"}'::text[],'FBC-10225','2022-01-15'::date,'tun',64,88),
  ('00000000-0000-0000-0000-000000025409'::uuid,'Sandra Bauer-Klein','prime','Immobilien-Investorin','{Investorin,Unternehmerin}'::text[],'München','BK Real Estate','Immobilien','DEMO-Profil — fiktive Daten. Value-Add-Immobilien im süddeutschen Raum.','{"Real Estate","Asset Management","Finanzierung"}'::text[],'{"Immobilien","Wohnen","Value Add"}'::text[],'FBC-10232','2021-09-01'::date,'haben',72,94),
  ('00000000-0000-0000-0000-000000025410'::uuid,'Markus Frey','prime','HealthTech-Gründer','{"Gründer","CEO"}'::text[],'München','Frey Health GmbH','Gesundheit','DEMO-Profil — fiktive Daten. Digital-Health-Plattform in der Wachstumsphase, sucht Series-A-Kapital.','{"HealthTech","Regulatory","Product"}'::text[],'{"Digital Health","KI","Prävention"}'::text[],'FBC-10239','2023-02-01'::date,'tun',66,90),
  ('00000000-0000-0000-0000-000000025411'::uuid,'Marek Novak','prime','Unternehmensberater','{"Berater"}'::text[],'Berlin','Novak Consulting','Beratung','DEMO-Profil — fiktive Daten. Begleitet B2B-Unternehmen bei Skalierung und digitaler Transformation.','{"Strategie","Digitale Transformation","Vertrieb"}'::text[],'{"Beratung","Skalierung","B2B"}'::text[],'FBC-10246','2022-06-01'::date,'tun',62,86),
  -- new discover
  ('00000000-0000-0000-0000-000000025412'::uuid,'Aylin Demir','discover','Gründerin · DeepTech','{"Gründerin"}'::text[],'Stuttgart','Demir Labs','Technologie','DEMO-Profil — fiktive Daten. DeepTech-Ausgründung, sucht erste Finanzierung und Mentoring.','{"Machine Learning","Forschung"}'::text[],'{"DeepTech","KI","Forschung"}'::text[],'FBC-10461','2024-11-01'::date,'tun',38,55),
  ('00000000-0000-0000-0000-000000025413'::uuid,'Robert Vogt','discover','Dienstleister · Mittelstand','{"Unternehmer"}'::text[],'Köln','Vogt Services','Dienstleistung','DEMO-Profil — fiktive Daten. Wachsendes Dienstleistungsunternehmen, sucht Partner und Kunden.','{"Service","Logistik","Operations"}'::text[],'{"Mittelstand","Digitalisierung"}'::text[],'FBC-10468','2025-01-01'::date,'tun',42,50),
  ('00000000-0000-0000-0000-000000025414'::uuid,'Mira Sänger','discover','Kreativunternehmerin','{"Gründerin","Designerin"}'::text[],'Berlin','Saenger Studio','Kreativwirtschaft','DEMO-Profil — fiktive Daten. Design- und Markenstudio, sucht Mentoring und Fachexpertise.','{"Design","Branding","Content"}'::text[],'{"Design","Creator Economy","Marke"}'::text[],'FBC-10475','2024-12-01'::date,'sein',44,58)
