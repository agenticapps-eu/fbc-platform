...
--    profiles row (tier 'active'); section 3 enriches it. Idempotent.
...
from (values
  ...
  ('2752a480-a737-4f90-af0c-a76722c781a7'::uuid,'Jonas Keller','boost','Gründer · B2B-SaaS','{"Gründer"}'::text[],'Stuttgart','Keller Ventures','Technologie','DEMO-Profil — fiktive Daten. Frühphasen-Gründer auf der Suche nach Kapital und Mentoring.','{"Product Management","SaaS","Vertrieb"}'::text[],'{"Startups","Fintech","KI"}'::text[],'FBC-10455','2024-09-01'::date,'tun',40,60),
  -- new legacy
  ...
  -- new connect (Rang 3)
  ('00000000-0000-0000-0000-000000025412'::uuid,'Aylin Demir','boost','Gründerin · DeepTech','{"Gründerin"}'::text[],'Stuttgart','Demir Labs','Technologie','DEMO-Profil — fiktive Daten. DeepTech-Ausgründung, sucht erste Finanzierung und Mentoring.','{"Machine Learning","Forschung"}'::text[],'{"DeepTech","KI","Forschung"}'::text[],'FBC-10461','2024-11-01'::date,'tun',38,55),
  ('00000000-0000-0000-0000-000000025413'::uuid,'Robert Vogt','boost','Dienstleister · Mittelstand','{"Unternehmer"}'::text[],'Köln','Vogt Services','Dienstleistung','DEMO-Profil — fiktive Daten. Wachsendes Dienstleistungsunternehmen, sucht Partner und Kunden.','{"Service","Logistik","Operations"}'::text[],'{"Mittelstand","Digitalisierung"}'::text[],'FBC-10468','2025-01-01'::date,'tun',42,50),
  ('00000000-0000-0000-0000-000000025414'::uuid,'Mira Sänger','boost','Kreativunternehmerin','{"Gründerin","Designerin"}'::text[],'Berlin','Saenger Studio','Kreativwirtschaft','DEMO-Profil — fiktive Daten. Design- und Markenstudio, sucht Mentoring und Fachexpertise.','{"Design","Branding","Content"}'::text[],'{"Design","Creator Economy","Marke"}'::text[],'FBC-10475','2024-12-01'::date,'sein',44,58),
  -- new discover (Rang 4) — AGE-357, Schluessel ab AGE-903 `discover`.
  -- Mitgliedsnummern 103xx: invers zum Rang, zwischen focus (102xx) und
  -- der Stufe darunter (1038x).
  ('00000000-0000-0000-0000-000000025415'::uuid,'Anna Müller','discover','Geschäftsführerin · Familienunternehmen','{Unternehmerin,"Geschäftsführerin"}'::text[],'Stuttgart','Müller Präzisionsteile GmbH','Industrie','DEMO-Profil — fiktive Daten. Führt ein Familienunternehmen in dritter Generation und bereitet die Nachfolge vor.','{"Produktion","Nachfolge","Vertrieb"}'::text[],'{"Unternehmensnachfolge","Mittelstand","Automatisierung"}'::text[],'FBC-10310','2023-03-01'::date,'tun',58,78),
  ('00000000-0000-0000-0000-000000025416'::uuid,'Christoph Seidel','discover','Steuerberater · Mittelstand','{Berater,"Steuerberater"}'::text[],'München','Seidel & Kollegen','Beratung','DEMO-Profil — fiktive Daten. Steuerliche Gestaltung für inhabergeführte Unternehmen und Nachfolgen.','{"Steuerrecht","Nachfolgeplanung","Bilanzierung"}'::text[],'{"Unternehmensnachfolge","Mittelstand","Vermögensstruktur"}'::text[],'FBC-10317','2023-06-15'::date,'tun',60,80),
  ('00000000-0000-0000-0000-000000025417'::uuid,'Ruth-Maria Wagner','discover','Handelsunternehmerin','{Unternehmerin}'::text[],'Köln','Wagner Handel KG','Handel','DEMO-Profil — fiktive Daten. Großhandel im Umbau auf E-Commerce, sucht Partner und Expertise.','{"Einkauf","Logistik","E-Commerce"}'::text[],'{"Digitalisierung","Handel","Nachhaltigkeit"}'::text[],'FBC-10324','2023-09-01'::date,'haben',56,76),
  -- new connect (Rang 3) — AGE-357, Schluessel ab AGE-903 `connect`.
  --
  -- Der Schluessel dieser Gruppe hat jetzt ZWEIMAL die Bedeutung gewechselt:
  -- AGE-311 mappte das alte `discover` auf `connect`, AGE-903 hat `discover`
  -- um einen Rang gehoben und diese Gruppe damit auf `connect` gesetzt. Gemeint
  -- ist durchgehend DERSELBE Rang 3 — nur heisst er jedes Mal anders. Nach
  -- AGE-903 liegt er ausserhalb des Clubs.
  ('00000000-0000-0000-0000-000000025418'::uuid,'Katharina Bruns','connect','Gründerin · Nachhaltige Verpackung','{"Gründerin"}'::text[],'Hamburg','Bruns Packaging','Industrie','DEMO-Profil — fiktive Daten. Entwickelt kompostierbare Verpackungen und sucht erste Kunden im Mittelstand.','{"Materialentwicklung","Produktion"}'::text[],'{"Nachhaltigkeit","Kreislaufwirtschaft","Industrie"}'::text[],'FBC-10380','2024-03-01'::date,'tun',50,66),
  ('00000000-0000-0000-0000-000000025419'::uuid,'Julian Maier','connect','Selbstständiger IT-Berater','{Berater}'::text[],'Stuttgart','Maier IT','Technologie','DEMO-Profil — fiktive Daten. IT-Beratung für Mittelständler, will vom Einzelkämpfer zum Team wachsen.','{"IT-Infrastruktur","Cloud","Security"}'::text[],'{"Digitalisierung","Mittelstand","Cloud"}'::text[],'FBC-10387','2024-05-15'::date,'tun',48,64),
  ('00000000-0000-0000-0000-000000025420'::uuid,'Fatima Cheddadi','connect','Architektin · Bestandssanierung','{Architektin,"Unternehmerin"}'::text[],'Frankfurt','Cheddadi Architektur','Immobilien','DEMO-Profil — fiktive Daten. Sanierung von Bestandsgebäuden, sucht Projektpartner und Bauherren.','{"Architektur","Sanierung","Bauleitung"}'::text[],'{"Nachhaltiges Bauen","Immobilien","Denkmalschutz"}'::text[],'FBC-10394','2024-08-01'::date,'tun',52,68),
  -- new active (Rang 1) — AGE-357, Schluessel ab AGE-903 `active`. Neu dabei,
  -- Profil noch dünn: niedrigster dev_progress/profile_completion im ganzen
  -- Seed, jüngstes member_since.
  ('00000000-0000-0000-0000-000000025421'::uuid,'Timo Reuter','active','Gründer · Handwerk-Plattform','{"Gründer"}'::text[],'Stuttgart','Reuter Digital','Technologie','DEMO-Profil — fiktive Daten. Frisch im Club, baut eine Vermittlungsplattform für Handwerksbetriebe.','{"Product","Marktplatz"}'::text[],'{"Startups","Handwerk","Plattformen"}'::text[],'FBC-10520','2026-04-01'::date,'tun',26,34),
  ('00000000-0000-0000-0000-000000025422'::uuid,'Sofia Kranz','active','Freiberufliche Texterin','{Freiberuflerin}'::text[],'Berlin','—','Kreativwirtschaft','DEMO-Profil — fiktive Daten. Neu im Club, orientiert sich noch und sucht erste Kontakte.','{"Text","Content"}'::text[],'{"Kommunikation","Marke"}'::text[],'FBC-10527','2026-05-15'::date,'sein',22,30),
  ('00000000-0000-0000-0000-000000025423'::uuid,'David Öztürk','active','Handwerksunternehmer · Elektrotechnik','{Unternehmer}'::text[],'Köln','Öztürk Elektro GmbH','Handwerk','DEMO-Profil — fiktive Daten. Elektrobetrieb mit 12 Mitarbeitenden, gerade beigetreten.','{"Elektrotechnik","Projektabwicklung"}'::text[],'{"Handwerk","Fachkräfte","Energie"}'::text[],'FBC-10534','2026-06-01'::date,'haben',30,40)
