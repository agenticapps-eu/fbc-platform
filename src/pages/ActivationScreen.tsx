    ...
    <main className="mx-auto flex min-h-screen max-w-md flex-col justify-center gap-6 p-6">
      ...
      {gesendet && (
        <p className="rounded-md border border-success/30 bg-success/10 p-3 text-sm text-success">
          ...
          Absender ist <strong>noreply@effbeezee.com</strong>. Die Adresse sieht ungewohnt aus,
          gehört aber zum Club; antworten kannst du auf die Mail, sie landet bei uns.
        </p>
      )}
