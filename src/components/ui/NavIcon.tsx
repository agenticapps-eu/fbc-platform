...
const ICONS: Record<string, ReactElement> = {
  ...
  "/meine-kurse": (
    <>
      <path d="M4 5.5h5.5c1.4 0 2.5 1 2.5 2.3V19c0-1.1-1-1.9-2.2-1.9H4z" />
      <path d="M20 5.5h-5.5c-1.4 0-2.5 1-2.5 2.3V19c0-1.1 1-1.9 2.2-1.9H20z" />
    </>
  ),
  "/kontakte": (
    <>
...
const FILLED: Record<string, ReactElement> = {
  ...
  "/meine-kurse": (
    <>
      <path d="M3.4 4.8h6c1.6 0 2.9 1.2 2.9 2.7v11.9c-.5-.9-1.6-1.4-2.7-1.4h-6a.6.6 0 0 1-.6-.6V5.4a.6.6 0 0 1 .6-.6Z" />
      <path d="M20.6 4.8h-6c-1.6 0-2.9 1.2-2.9 2.7v11.9c.5-.9 1.6-1.4 2.7-1.4h6a.6.6 0 0 0 .6-.6V5.4a.6.6 0 0 0-.6-.6Z" />
    </>
  ),
  "/kontakte": (
    <>
